...
Opus 4.8은 Claude Code v2.1.154 이상에서 빠른 모드 기본값입니다. v2.1.142부터 v2.1.153까지는 빠른 모드가 Opus 4.7로 기본 설정됩니다. 대신 빠른 모드를 Opus 4.6에 고정하려면 `CLAUDE_CODE_OPUS_4_6_FAST_MODE_OVERRIDE=1`을 설정합니다. 이 재정의는 Opus 4.6의 빠른 모드가 중단될 때 제거됩니다.
