...
<Info>
  **Claude Opus 4.8을 이제 사용할 수 있습니다.** Claude Code GitHub Actions는 기본적으로 Sonnet을 사용합니다. Opus 4.8을 사용하려면 [모델 파라미터](#breaking-changes-reference)를 `claude-opus-4-8`을 사용하도록 구성하십시오.
</Info>
