...
<h2 id="how-ultrareview-compares-to-/review">
...
작업하는 동안 빠른 피드백을 위해 `/review`를 사용합니다. 단일 리뷰에서 놓칠 수 있는 문제를 포착하는 더 깊은 패스를 원할 때 실질적인 변경 사항을 병합하기 전에 `/code-review ultra`를 사용합니다.
