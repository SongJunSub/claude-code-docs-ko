...
<div className="digest-meta">
  <span>Releases <a href="/ko/changelog#2-1-150">v2.1.150 → v2.1.157</a></span>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    ...
    <div>스트리밍 도구 실행은 이제 항상 활성화되어 있으며, 원격 측정이 비활성화되고 Bedrock, Vertex 및 Foundry에서도 포함됩니다.</div>
    <div>에이전트 보기를 열기 위해 <code>←←</code>는 이제 Bedrock, Vertex, Foundry 및 원격 측정이 비활성화된 상태에서 작동합니다.</div>
...
[Full changelog for v2.1.150–v2.1.157 →](/ko/changelog#2-1-150)
